...
El siguiente informe corresponde al proceso de diseño, armado y analisis de un filtro \textit{Notch} o \textit{Elimina-banda} para la frecuencia de $1\ kHz$ a partir de  una imagen del diagrama de \textit{Bode} para el modulo. Notando que para el resto de las frecuencias, existia un nivel dde amplificacion, se decidio armar un filtro \textit{Notch} en cascada con un amplificador no inversor
}
