...
El siguiente informe corresponde al proceso de diseño, armado y analisis de un filtro \textitt{Notch} o \textitt{Elimina-banda} para la frecuencia de $1 kHz$ a partir de  una imagen del diagrama de Bode para el modulo. 
}
