...
\hfill
\subfloat[Diagrama de Bode de fase en Pyton]{
\begin{minipage}[c]{1\textwidth}
	\centering
	\includegraphics[width=15cm]{imagenes/BodeFase}	%\caption{Diagrama de Bode de fase en Pyton}
\end{minipage}
}
...
\begin{centering}
	...
	\begin{minipage}[b]{.4\linewidth}
	\centering
	\includegraphics[width=1.3\linewidth]{imagenes/Sim}
	\caption{Respuesta al escal\'on del circuito simulado}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{.4\linewidth}
